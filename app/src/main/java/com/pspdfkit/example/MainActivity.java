...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareAndShowDemoDocument() {
        ...
        // done
        // once, and allows to make changes to the document and to persist them. Every subsequent
        // call
    ...
    private void launchPdfActivity(@NonNull final Uri uri) {
        ...
        // appropriate
        // intent, you need to use the PdfActivityIntentBuilder which will handle adding all
        // relevant
